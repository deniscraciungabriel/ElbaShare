...
class MainPageTendenze extends StatefulWidget {
  final user;
  bool recent = false;
  // ignore: use_key_in_widget_constructors
  MainPageTendenze(this.user);

  @override
  _MainPageTendenzeState createState() => _MainPageTendenzeState();
}

class _MainPageTendenzeState extends State<MainPageTendenze> {
  var imageUrl;
          ...
          OutlinedButton(
              ...
              onPressed: () => {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => MainPage(widget.user)))
                  },
              child: Text("Recenti",
                  style: TextStyle(color: Color.fromRGBO(0, 158, 149, 2)))),
        ]),
