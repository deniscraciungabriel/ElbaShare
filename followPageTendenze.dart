...
import 'package:elbashare/story.dart';
import 'package:elbashare/story_posting.dart';
import 'package:page_transition/page_transition.dart';
import 'FollowPageTendenze.dart';
import 'package:elbashare/followPageTendenze.dart';
...
class FollowPageTendenze extends StatefulWidget {
  final user;
  bool recent = false;
  // ignore: use_key_in_widget_constructors
  FollowPageTendenze(this.user);

  @override
  _FollowPageTendenzeState createState() => _FollowPageTendenzeState();
}

class _FollowPageTendenzeState extends State<FollowPageTendenze> {
  var imageUrl;
                                  ...
                                  if (data2.hasData) {
                                    ...
                                    return (!user["Viewed"].contains(story
                                                ...
                                                .substring(story.docs[index]
                                                        ...
                                                        .length -
                                                    15)) &&
                                            user["Followed"].contains(
                                                story.docs[index]["UID"]))
                                        ? Padding(
                                            padding: const EdgeInsets.only(
                                                right: 8.0),
          ...
          OutlinedButton(
              ...
              onPressed: () => {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => FollowPage(widget.user)))
                  },
              child: Text("Recenti",
                  style: TextStyle(color: Color.fromRGBO(0, 158, 149, 2)))),
        ]),
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text("(Home Seguiti)", style: TextStyle(fontSize: 15))
          ],
        ),
      ),
